...
def test_arguments():
    ...
    arg_spec = inspect.getfullargspec(h.assert_index_equal_msg)
...
def test_pandas_assert_index_called(mocker):
    ...
    h.assert_index_equal_msg(expected=srs, actual=srs2, msg_tag="a", check_names=True)
