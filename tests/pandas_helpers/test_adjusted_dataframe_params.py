...
def test_arguments():
    """Test arguments for arguments of test_aide.pandas_helpers.adjusted_dataframe_params."""
...
def test__index_preserved_params_call():
    ...
    with mock.patch.object(
        test_aide.pandas_helpers, "index_preserved_params"
    ) as mocked:
...
def test__row_by_row_params_call():
    ...
    with mock.patch.object(test_aide.pandas_helpers, "row_by_row_params") as mocked:
